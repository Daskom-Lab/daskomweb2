...
export default function TKReview() {
    ...
    useEffect(() => {
        const storedQuestions = JSON.parse(localStorage.getItem("tkQuestions")) || [];
        const storedAnswers = JSON.parse(localStorage.getItem("tkAnswers")) || [];
        const storedCorrectAnswers = JSON.parse(localStorage.getItem("tkCorrectAnswers")) || [];
