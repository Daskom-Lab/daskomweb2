    ...
    return (
        <div className="w-1/2 my-10 px-10">
            ...
            <form className="flex flex-col gap-4">
                <input className="bg-lightGray py-1 px-4 mt-10 rounded-sm border-dustyBlue border-2 placeholder-dustyBlue" type="text" inputMode="numeric" pattern="[0-9]*" name="nim" placeholder="NIM" />
                <div className="relative">
                    <input className="bg-lightGray py-1 px-4 mt-1 w-full rounded-sm border-dustyBlue border-2 placeholder-dustyBlue" type={passwordVisible ? 'text' : 'password'} name="password" placeholder="Password" id="password" />
                    <img className='w-4 cursor-pointer absolute top-[55%] right-3 transform -translate-y-1/2' src={passwordVisible ? eyeOpen : eyeClose} alt="Toggle Password Visibility" 
