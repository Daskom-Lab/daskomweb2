...
export default function TesAwal({ 
    ...
    const questions = [
        {
            question: "Apa perbedaan 'int' dan 'float' dalam bahasa C?",
            options: [
        ...
        {
            question: "Apa yang dimaksud dengan pointer dalam bahasa C?",
            options: [
        ...
        {
            question: "Jelaskan konsep array multidimensi dalam bahasa C.",
            options: [
    ...
    const [userAnswers, setUserAnswers] = useState(() => {
        const savedAnswers = localStorage.getItem("taAnswers");
    ...
    useEffect(() => {
        ...
        localStorage.setItem("taQuestions", JSON.stringify(questions));
    }, []);

    useEffect(() => {
        const correctAnswers = [0, 0, 2]; 
        localStorage.setItem("taCorrectAnswers", JSON.stringify(correctAnswers));
    }, []);   
    ...
    const handleSubmit = () => {
        localStorage.setItem("taAnswers", JSON.stringify(userAnswers)); 
